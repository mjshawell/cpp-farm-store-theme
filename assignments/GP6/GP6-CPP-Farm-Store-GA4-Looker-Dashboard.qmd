...
Store's live Shopify store does not yet have production GA4 traffic, this
...
- Track conversion behavior through the funnel (view → cart → checkout → purchase)
...
- **GA4 (simulated):** 30 days of session, engagement, and funnel data across
  ...
  Shopify store yet.*
- **Shopify (GP2):** informs which pages/products are being measured
- **Google Merchant Center (GP3):** informs the 6 product categories tracked
...
**Data limitations:**
This dashboard uses simulated GA4 data because CPP Farm Store's Shopify store
...
- **GitHub Repository:** [mjshawell/cpp-farm-store-theme](https://github.com/mjshawell/cpp-farm-store-theme)
- **GitHub Pages:** [Live Site](PASTE_GITHUB_PAGES_URL_HERE)
- **Simulated GA4 Dataset (CSV):** included in `docs/assignments/GP6/data/ga4_simulated_data.csv`
