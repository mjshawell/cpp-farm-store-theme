...
## Suggested Weekly Publishing Schedule

To maintain consistent engagement, the campaign should follow a recurring weekly publishing schedule that reinforces the "Fresh This Week" message and encourages repeat visits throughout the semester.

| Day | Channel | Content |
|------------------------|------------------------|------------------------|
| Monday | Instagram Feed + Website | Launch the week's featured products and update the homepage banner. |
| Wednesday | Instagram Story | Share a midweek reminder, behind-the-scenes content, or a featured product highlight. |
| Thursday | Email Newsletter | Promote seasonal products, Farm Rewards, and campus gift ideas. |
| Friday | Instagram Story | Create urgency by reminding customers that featured products may sell out before the weekend. |
| Weekend | Campaign Planning | Prepare photography, verify inventory, and schedule content for the following week's campaign. |

The schedule should remain flexible to accommodate seasonal inventory changes and product availability while maintaining a consistent weekly content cadence.
...
## Creative Asset Strategy Summary

The campaign assets are designed to work together as an integrated marketing campaign rather than as separate promotional pieces. Each channel supports a different stage of the customer journey while maintaining consistent messaging, branding, and the "Fresh This Week" campaign theme.

| Asset | Primary Audience | Funnel Stage | Primary Call to Action | Intended Outcome |
|---------------|---------------|---------------|---------------|---------------|
| Instagram Feed Post | CPP students | Awareness | Visit the Farm Store this week | Increase awareness of weekly featured products |
| Instagram Story | Students on or near campus | Consideration | Stop by before Friday | Encourage immediate in-store visits |
| Farm Rewards Email | Returning customers, faculty, and staff | Retention | See What's Fresh | Increase repeat visits and loyalty participation |
| Website Banner | Website visitors | Conversion | Shop This Week's Picks | Drive visitors toward featured products and store information |

Together, these assets create a consistent customer experience by introducing the campaign on social media, reinforcing it through email, and guiding customers to the website for additional information and in-store visits.
...
-   **Conceptual vs. ready-to-use:** All four assets are **conceptual drafts** suitable for course submission and internal review. None are ready to publish as-is — captions would need final photography, the email needs integration into the store's actual email platform, and the banner needs a real product photo before it could go live on the Shopify site.
    ...
    The campaign assets should be designed to remain accessible and easy to understand across devices while supporting a wide range of users.

    -   Include descriptive alternative (alt) text for product and promotional images.
    -   Maintain sufficient color contrast between text and backgrounds.
    -   Use readable font sizes on both desktop and mobile devices.
    -   Provide captions for video and Instagram Story content.
    -   Avoid communicating important information through color alone.
    -   Use descriptive call-to-action buttons such as "See What's Fresh" instead of generic labels like "Click Here."
    -   Ensure website buttons and navigation remain keyboard accessible.

    Applying these accessibility practices helps create a more inclusive experience while supporting the campaign's mobile-first audience.
...
-   Together, they cover awareness (Instagram), retention (email), and conversion (website + in-store), matching the funnel structure already defined in GP4's channel strategy table
    ...
    To evaluate whether the campaign assets are successfully supporting the GP4 marketing objectives, the group recommends monitoring the following performance indicators after implementation.

    | Campaign Goal | Performance Indicator |
    |------------------------------------|------------------------------------|
    | Increase awareness | Instagram reach, impressions, and profile visits |
    | Generate interest | Story replies, saves, shares, and website clicks |
    | Encourage store visits | QR-code scans, direction requests, and in-store customer mentions |
    | Build customer retention | Farm Rewards sign-ups and repeat visits |
    | Support email engagement | Email open rate and click-through rate |
    | Improve product discovery | Visits to the weekly featured-products collection |

    These indicators are recommended measures for evaluating campaign performance.
